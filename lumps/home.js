              ...
              $themeDropdown
                .api({
                  ...
                  onSuccess: function(content) {
                    ...
                    $.proxy(chronimi.handler.initializeCode, $overrideCode[0])();
                  }
                })
              ;
              $variableCode.html(content);
              $.proxy(chronimi.handler.initializeCode, $variableCode[0])();
            }
          })
        ;
      }
